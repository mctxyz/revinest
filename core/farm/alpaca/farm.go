...
func NewAlpacaFarm(farmConfig *config.FarmConfig, client *ethclient.Client, tokenBasic *token.TokenBasic, printer *printer.Printer) *AlpacaFarm {
	return &AlpacaFarm{
...
func (c *AlpacaFarm) RewardToken() *token.Token {
	return c.RewardTokenInfo
}
func (c *AlpacaFarm) Harvest() (*big.Int, error) {
...
func (c *AlpacaFarm) SwapRewardToPairWithRetry(rewardAmount *big.Int, tryCount int) (*big.Int, *big.Int, string, string, error) {
...
func (c *AlpacaFarm) AddLiquidityWithRetry(wishA *big.Int, wishB *big.Int, tokenAAddress, tokenBAddress string, tryCount int) (string, error) {
	count := 1
...
func (c *AlpacaFarm) Reinvest() (*big.Int, string, error) {
...
func (c *AlpacaFarm) LpToken() *token.Token {
	return c.LpTokenInfo
}
func (c *AlpacaFarm) Start() error {
